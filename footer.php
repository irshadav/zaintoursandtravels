  ...
  <div class="myrow">
    <footer class="row" >
      <div class="fullcolumns">
        <div class="footer">
          <div class="large-12 columns" style="padding:0 0 10px 0;">
       <div class="companyname">Eppco Apartments</div>
       <div class="copyright"> | 2014 (c) All rights reserved  | <a href="sitemap.php" class="sevenfiv">Sitemap</a> | <a href="privacy.php" class="sevenfiv">Privacy</a> 
       <!-- |  <a class="sevenfiv" href="http://www.sevenfiv.com" target="blank">Built Team</a> -->
...
<script type="text/javascript">
  ...
  $('.bxslider').bxSlider();
    ...
    <script src="js/foundation/custom.js"></script>
    <script>
      $(document).foundation();
    </script>
  </body>
